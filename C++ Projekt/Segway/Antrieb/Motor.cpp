...
{
    VINTP GPER = (int*)(GPIO_MODULE + (Configuration::Motor_enabledPinPort ? GPIO_PORT_OFFSET : 0) + GPIO_GPER_OFFSET);
    SET_BIT(*GPER, Configuration::Motor_enabledPinPin);
    VINTP ODER = (int*)(GPIO_MODULE + (Configuration::Motor_enabledPinPort ? GPIO_PORT_OFFSET : 0) + GPIO_ODER_OFFSET);
    SET_BIT(*ODER, Configuration::Motor_enabledPinPin);
    VINTP OVR = (int*)(GPIO_MODULE + (Configuration::Motor_enabledPinPort ? GPIO_PORT_OFFSET : 0) + GPIO_OVR_OFFSET);
...
bool Motor::init(Configuration::s_MotorConfig* thisMotorConfig_)
{
    ...
    // init register
    OVR = (int*)(GPIO_MODULE + (thisMotorConfig_->directionPinPort ? GPIO_PORT_OFFSET : 0) + GPIO_OVR_OFFSET);
...
{
    // read enable value
    VINTP PVR = (int*)(GPIO_MODULE + (Configuration::Motor_enabledPinPort ? GPIO_PORT_OFFSET : 0) + GPIO_OVR_OFFSET);
